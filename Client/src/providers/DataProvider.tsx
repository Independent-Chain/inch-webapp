...
export interface ContextType {
    ...
    * `
    */
   addParentField(field: string, fieldData: Record<string, any>): void;
    ...
    * ```
    */
   updateExistingField(path: string, value: unknown): void;
    ...
    * ```
    */
   overwriteData(newData: Record<string, any>): void;
}
